...
```{r plot_main, echo=TRUE, warning=FALSE, fig.align='center', fig.height=7, fig.width=7}
...
From that, We don't see if there is an amelioration or not after your first trial (dashed rectangle), although we are still amazed that you kept trying after your first time! Ouh... You definitely know how to get back up.

## 3. Generate the inset figure

```{r plot_inset, eval=FALSE, echo=TRUE, warning=FALSE, fig.align='center', fig.height=7, fig.width=7}
