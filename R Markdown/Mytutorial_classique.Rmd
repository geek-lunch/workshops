...
Now let's go back to pictures.
Sometimes you might want to include a figure that you made in an other script or just a picture to illustrate an element. Then you use the following line.  

![](C:/Users/vuill/Pictures/CremeSolaire.jpg)  
\
You might want to adjust the size of this picture then you add ```{ width=50% }``` at the end of the previous line. Of course you can change the purcentage as you wish.  
![](C:/Users/vuill/Pictures/CremeSolaire.jpg){ width=50% }

\
You might also want to center this image on the document.
<center>
![](C:/Users/vuill/Pictures/CremeSolaire.jpg){ width=30% }  
</center>  
